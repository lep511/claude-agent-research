...
def print_markdown_result(messages: list[Any]) -> None:
    """
    Print the last assistant text response rendered as rich Markdown.

    Args:
        messages: List of conversation messages from the agent response stream.
    """
    for msg in reversed(messages):
        if msg.__class__.__name__ == "AssistantMessage" and hasattr(msg, "content") and msg.content:
